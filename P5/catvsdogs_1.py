...
#Full 20k data but original parameters (16/32/128) and 2401 runs. Validation accuracy highest - 72.6%. Minibatch accuracy hovered around 82%. 
#Took about 15 min to run. Not bad! 
...
#Full 20k data but original parameters (16/32/128) and 2401 runs. Introduced dropout, regularization and learning rate decay
#Validation accuracy highest - 70%. Minibatch accuracy hovered around 75%. 
#Took about 20 min to run. Not bad! 
